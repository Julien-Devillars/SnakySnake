...
public class Trail : MonoBehaviour
{
    ...
    public static Color mStartColor = new Color(250 / 255f, 49f / 255f, 98 / 255f);
    public static Color mEndColor = new Color(249 / 255f, 152 / 255f, 29 / 255f);
    public bool mIsFake;
    ...
    void Awake()
    {
        ...
        collider.size = new Vector2(transform.localScale.x - 0.15f, transform.localScale.x - 0.15f);
